      ...
      >
        <div className="maincontent p-6 bg-[#fff] rounded-[20px] shadow-lg">
          ...
          <div className="posts mt-[100px] font-montserrat">
            ...
            <p className="mt-2">
              {desc ? desc :<>
              <p><input className="border py-1 px-2 border-gray-300" type="text" placeholder="Your profile info goes here." /> <button className="bg-blue-700 py-1 px-2 rounded-md text-white ">Edit info</button></p>
              </>}
            </p>
          </div>
